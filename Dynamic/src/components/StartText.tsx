	...
	return (
		<div className="textFlex">
			...
			<animated.h2 className="right" ref={refSlideIn1} style={slideIn1}>
				Nu ze in de ruimte zijn, blijken er nog steeds problemen met de raket van fabrikant Boeing. Er zouden lekkages zijn en door hitteproblemen komt er te weinig brandstof in de raket. Voor de veiligheid stappen de astronauten dus nog even niet in
				de Starliner voor hun terugritje.
			</animated.h2>
		</div>
	);
}
